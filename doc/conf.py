# -*- coding: utf-8 -*-
#
# Flowtracks documentation build configuration file, created by
...
texinfo_documents = [
  ('index', 'Flowtracks', u'Flowtracks Documentation',
   u'Yosef Meller', 'Flowtracks', 'One line description of project.',
   'Miscellaneous'),
]
